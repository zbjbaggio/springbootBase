package com.springboot.base.util.excel;

import com.springboot.base.util.ReflectUtil;
...
//            cell.setCellStyle(contentStyle);
            setRowValue(list.get(i), contentStyle, fields, row, sheet);
        }
        for (int i = 0; i < 11; i++) {
    ...
    // 填写sheet的每行的值
    private static void setRowValue(Object obj,HSSFCellStyle contentStyle, List<String> fields, HSSFRow row, HSSFSheet sheet) {
